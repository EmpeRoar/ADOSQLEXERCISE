...
CREATE TABLE Organization.CompanyAddress (  
	CompanyId           int               NOT NULL,
	AddressId           int               NOT NULL,
    CONSTRAINT AK_CompanyAddress UNIQUE (CompanyId,AddressId)
); 
GO
...
insert into Organization.CompanyAddress(CompanyId, AddressId)
values (1,1),
       (1,2),
       (2,3),
       (2,4);
