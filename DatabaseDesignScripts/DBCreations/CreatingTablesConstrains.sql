...
-- CONSTRAINT AK_Attendees_UserConnection_Users  UNIQUE CLUSTERED (MessagingUserId, ConnectedToMessagingUserId)
	,
...
CREATE TABLE Messages.Topic ( 
	TopicId int NOT NULL CONSTRAINT DFLTMessage_Topic_TopicId
		...
		CONSTRAINT PK_Messages_Topic PRIMARY KEY,  -- constrain added
	 -- CONSTRAINT PK_Messages_Topic PRIMARY KEY (ExampleKeyColumn1, ExampleKeyColumn2),
